                ...
                try:
                    ...
                    if stage_fd is not None and not published:
                        try:
                            ...
                            archive_error.add_note(
                                "POSIX orphan stage directory was preserved "
                                "for future safe GC; cleanup through its "
                                "original directory descriptor was incomplete"
                            )
                        else:
                            archive_error.add_note(
                                "POSIX cleanup unlinked owned stage files "
                                "through the original directory descriptor; "
                                "the empty orphan stage directory was "
                                "preserved for future safe GC"
                            )
                    raise
                finally:
